...
import br.com.fiap.api.pagamentos.application.gateway.MercadoPagoWebhookGateway;
...
public class PaymentController {
    ...
    public ResponseEntity<BaseResponse<PaymentResponse>> makePayment(@RequestBody MakePaymentRequest request) throws Exception {
