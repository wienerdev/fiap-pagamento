package br.com.fiap.api.pagamentos.dataprovider.repository.impl;
...
import br.com.fiap.api.pagamentos.dataprovider.repository.PaymentRepositoryJpa;
...
public class PaymentRepositoryImpl implements PaymentRepository {
    ...
    public Payment makePayment(Payment payment) {
        PaymentEntity entity = new PaymentEntity(payment.getPaymentId(), payment.getOrder(), payment.getPaymentMethod());
